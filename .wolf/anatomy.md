...
- `KostZExport.swift` — KostZExporter: export(summary: KostZMonthSummary) and export(summary: KostZTournamentSummary), shared private patcher (~1500 tok)
...
- `Models.swift` — Class: User (~6697 tok)
...
- `TournamentsViews.swift` — SwiftUI view: AddTournamentView; TournamentDetailView has its own PRAE+KostZ "Berichte" menu, list view has neither anymore (~5300 tok)
