...
> Auto-maintained by OpenWolf. Last scanned: 2026-09-07T16:26:29.444Z
...
- `ios-build-deploy.yml` — CI: iOS Build and Deploy (~3922 tok)
...
- `TournamentsViews.swift` — SwiftUI view: AddTournamentView (~7766 tok)
...
- `TrainingsViews.swift` — SwiftUI view: AddTrainingView (~9502 tok)
